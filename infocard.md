...
| Tools | Git · npm · Webpack · Vite · HubSpot CLI · WordPress |
...
One or two sentences describing what the project is and what it does.
...
### Frontend Developer (HubSpot Technical Admin)
**WEOKIE Federal Credit Union** · Full-time
*Oct 2023 – Present*
...
**MBS Textbooks** · Full-time
*Jun 2022 – Oct 2023*
Remote

Supported 5,000+ end users across 800+ Barnes & Noble campus bookstore locations nationwide, resolving hardware and software issues across 20+ business applications. Built a single-file internal knowledge base tool using vanilla JavaScript, HTML, and CSS to centralize team resources, improving response time and first-call resolution. Handled escalated network and Microsoft systems administration issues.
...
- HubSpot CMS for Developers II (Sep 2024)
